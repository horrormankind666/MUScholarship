  ...
  $.fn.calendar.settings = {
    ...
    formatter: {
      ...
      date: function (date, settings) {
        ...
        var monthText = settings.text.months[date.getMonth()];
        var year = date.getFullYear();

        if (settings.monthFirst == false)
        {
            if (monthNumber < 10)
        ...
        return settings.type === 'year' ? year :
          settings.type === 'month' ? monthText + ' ' + year :
          (settings.monthFirst ? (monthText + ' ' + day + ', ' + year) : (day + '/' + (monthNumber < 10 ? ("0" + monthNumber) : monthNumber) + '/' + year));
