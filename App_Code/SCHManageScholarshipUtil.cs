...
public class SCHManageScholarshipUtil
{
    public static Dictionary<string, object> GetSearch(Dictionary<string, object> _paramSearch)
    {
        ...
        if (_paramSearch["ScholarshipsTypeGroup"].Equals(""))                   _list = SCHManageScholarshipUI.ListUI.GetMain(_dr);
        if (_paramSearch["ScholarshipsTypeGroup"].Equals(SCHUtil.SUBJECT_ICL))  _list = SCHManageScholarshipUI.ICLUI.ListUI.GetMain(_dr);
    ...
    public class StudentCancelUtil
    {
        public static Dictionary<string, object> GetSearch(Dictionary<string, object> _paramSearch)
        {
            Dictionary<string, object> _loginResult = SCHUtil.GetInfoLogin("", "");
            ...
            _recordCount        = _ds.Tables[0].Rows.Count;
            _recordCountPrimary = _ds.Tables[0].Rows.Count;
            if (_paramSearch["ScholarshipsTypeGroup"].Equals(""))                   _list = SCHManageScholarshipUI.StudentCancelUI.ListUI.GetMain(_dr);
            if (_paramSearch["ScholarshipsTypeGroup"].Equals(SCHUtil.SUBJECT_ICL))  _list = SCHManageScholarshipUI.ICLUI.StudentCancelUI.ListUI.GetMain(_dr);
